...
public class BluetoothPopUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetooth_pop_up);
        ...
        bluetoothSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                Log.d(TAG, "onChecked: Switch button to Enabling/Disabling Bluetooth");
                if(isChecked){
                ...
                if(mBluetoothAdapter ==null){
                    ...
                    if (!mBluetoothAdapter.isEnabled()) {
                        ...
                        //Intent filter records the state change
        ...
        connectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mBTDevice ==null)
                {
                    Toast.makeText(BluetoothPopUp.this, "Please select a device to connect.", Toast.LENGTH_LONG).show();
                }
                else {
                    startConnection();
                }
